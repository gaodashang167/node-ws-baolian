...
const UUID = process.env.UUID || 'c555b555-2ba2-4360-a55c-2adb2af0a607'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'iz2q6GK7gAFmQljm54fuePp3K98AqB0D';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'lijianshe-madebi.hf.space';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
