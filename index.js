...
const UUID = process.env.UUID || '19d84809-c507-40f2-8db5-f8cae71abd98'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'VnrTnhgoack6PhnRH6lyshe4OVkHmPyM';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'laohu.-usa.flootup.co';       // 填写项目域名或已反代的域名，不带前缀，例如：abc-domain.com
